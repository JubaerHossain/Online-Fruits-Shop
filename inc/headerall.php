...
<link rel="shortcut icon" href="/images/sl1.jpg (or ico?)" type="image/x-icon" />
...
<script type="text/javascript">
  $(document).ready(function($){
    ...
    <style>
        .mn li h4{padding-top: 8px;font-size: 16px;}
    </style>
</head>
<body>
  <div class="wrap">
								...
								<span class="no_product">
									...
									<?php  
										...
										if (Session::get("total") != false && Session::get("quan") != false) {
											echo "Tk " .Session::get("total"). ",Q = " . Session::get("quan");
										}else {
											echo "(empty)";
										}	
    ...
    <ul>
        ...
        <li>
            ...
            <ul class="mn">
                ...
                <?php
                $result = $cat->getallcatForFront();
                if ($result) {
                    while ($productValue = $result->fetch_assoc()) {
                        ?>
                        <li><a href="page.php?id=<?php echo $productValue['catId'];?>"><h4><?php echo $productValue['caName']; ?></h4></a></li>
